...
<Note>
  Current release: **v1.10.2**. This release removes globally-required secret metadata while keeping least-privilege guidance in the skill body and preserving all existing x402-layer functionality.
</Note>
