...
<Note>
  Current release: **v1.11.1**. This release keeps the webhook hardening guidance, preserves optional OpenWallet / OWS support, and adds direct fundraiser campaign management through owner-linked dashboard API keys alongside the PAT-backed MCP path.
</Note>
