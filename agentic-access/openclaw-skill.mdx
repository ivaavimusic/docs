...
<Note>
  Current release: **v1.10.1**. This release hardens metadata and least-privilege guidance for credentialed wallet flows, while keeping all existing x402-layer functionality intact.
</Note>
