...
<Note>
  Current release: **v1.10.6**. This release adds explicit Studio seller webhook signing guidance, documents the two-secret-hop settlement model, and keeps secret-bearing actions scoped to the exact runbook that needs them.
</Note>
