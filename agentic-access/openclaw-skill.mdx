...
<Note>
  Current release: **v1.10.0**. This release adds optional OpenWallet / OWS support for pay, discover, and sign-message flows while keeping private-key and AWAL modes intact.
</Note>
