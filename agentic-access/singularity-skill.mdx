...
This release adds optional OpenWallet / OWS support for pay, discover, and sign-message flows while keeping private-key and AWAL modes intact.
...
This is the portable skills.sh-compatible distribution for Singularity Layer.
...
Use the `singularity` skill when you want:

- one portable install for the broader Singularity platform
- the same core capabilities as the OpenClaw-native `x402-layer` skill
- a skills.sh-friendly agent surface instead of the ClawHub distribution

## Related surfaces

| Surface | Best for |
| --- | --- |
| `singularity` | Portable skills.sh distribution |
| `x402-layer` | OpenClaw / ClawHub distribution for the main Singularity payments and endpoint skill |
| `x402-compute` | OpenClaw / ClawHub distribution for Singularity Compute |

## Install source

- Skills.sh-style package: `https://github.com/ivaavimusic/singularity-skill`
