...
- **SGL Machines** — provision and manage VPS/GPU instances on Vultr or DigitalOcean (x402 on Base/Solana/MegaETH/Robinhood Chain — **Arc USDC for credit top-ups** — MPP via `mppx`, or pre-loaded USD credits; OWS auth, API keys, in-place resize).
...
| x402 Arc USDC | Live | EIP-3009 on Arc (chainId 5042); embedded facilitator with Alchemy-primary RPC failover; credit top-ups (min $5 — Arc gas is USDC); explorer.arc.io |
