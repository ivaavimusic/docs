...
Slayer AI lives at `/dashboard/slayer-ai` and has **53 tools** covering the entire x402Studio dashboard. It can read your data, create resources, update settings, and delete items — all from natural language chat.
