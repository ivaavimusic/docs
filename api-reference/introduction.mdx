...
This section uses Mintlify's API reference methodology instead of prose-only guides.

It covers the most important live API surfaces documented across the platform:
...
>
  This Mintlify API reference is driven by the repo's OpenAPI spec.
</Card>
