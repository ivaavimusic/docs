...
$1.00; 2,000 on `best` costs $20, and 200 on the grid costs $0.30. The per-million-token figures are the
...
{
  "x402Version": 1,
  "accepts": [{ "scheme": "exact", "network": "base", "maxAmountRequired": "400000", "payTo": "0x…", "asset": "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913" }],
  "singularity": {
    "product": "dataset_synth",
    "quote_id": "8cc8258d-…",
    "rows": 200, "tier": "fast", "price_usd": 0.4,
