...
| **SGL Processors** | [`@singularity-layer/cli`](https://www.npmjs.com/package/@singularity-layer/cli) — the `singularity` command, plus a TypeScript library entry for the signing and bundling helpers |
